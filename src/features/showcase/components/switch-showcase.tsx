...
export function SwitchShowcase() {
  ...
  return (
    <ComponentSection
      id="switch"
      title="Switch"
      description="Switches toggle a single item on or off. M3 switches have distinct track and thumb styling."
    >
      ...
      <DemoRow label="Example — Settings panel">
        <div className="flex flex-col gap-4 w-72 p-4 rounded-xl bg-surface-container border border-outline-variant">
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-on-surface">Email Digest</p>
